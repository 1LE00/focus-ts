  ...
  theme: {
    extend: {
      colors: {
        ...
        dark: "var(--color-dark)",
        task: "var(--color-task)",
        crimsonRed: "var(--color-crimsonred)",
        cerisePink: "var(--color-cerisepink)",
        indigo: "var(--color-indigo)",
        violet: "var(--color-violet)",
        denimBlue: "var(--color-denimblue)",
        dodgerBlue: "var(--color-dodgerblue)",
        skyBlue: "var(--color-skyblue)",
        turquoise: "var(--color-turquoise)",
        seaGreen: "var(--color-seagreen)",
        forestGreen: "var(--color-forestgreen)",
        limeGreen: "var(--color-limegreen)",
        oliveGreen: "var(--color-olivegreen)",
        lemonYellow: "var(--color-lemonyellow)",
      ...
      boxShadow: {
        ...
        fab: "4px 4px 8px rgba(0,0,0,0.15), -4px -4px 8px rgba(0,0,0,0.15);",
      },
    },
  },
  safelist: [
